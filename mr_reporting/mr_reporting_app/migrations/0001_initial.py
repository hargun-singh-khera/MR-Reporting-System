    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mr_reporting_app.citymaster')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(max_length=10, unique=True)),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mr_reporting_app.citymaster')),
            ],
        ),
        migrations.CreateModel(
            name='RequestsMaster',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mr_reporting_app.countrymaster')),
            ],
        ),
        migrations.AddField(
            model_name='citymaster',
            name='state',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mr_reporting_app.statemaster'),
        ),
        migrations.CreateModel(
            name='StockistMaster',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_area', to='mr_reporting_app.citymaster')),
                ('to_area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_area', to='mr_reporting_app.citymaster')),
            ],
        ),
        migrations.CreateModel(
            name='ProductMaster',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('areas', models.ManyToManyField(to='mr_reporting_app.citymaster')),
